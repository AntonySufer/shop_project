...
(function(root) {
  ...
  var toSign = function(token,param){
	    var list = [];  
	    $.each(param, function(key, val) { list[list.length] = key;  });  
	    list.sort(); 
	    var sign=token;
  ...
  var createMethod = function () {
    ...
    method.toSign = function (token,param) {
        return method.create().update(toSign(token,param)).hex();
    };
